The variable path_to_blender in launch_blender.py need to be change with the path of the launcher of blender, also change the nb_sample in the same file.
